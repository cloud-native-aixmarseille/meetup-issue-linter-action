...
import {
	...
	type MeetupIssue,
	type MeetupIssueBody,
	type MeetupIssueBodyFields,
	MeetupIssueService,
} from "../../services/meetup-issue.service.js";
import { LintError } from "../lint.error.js";
import type { LinterAdapter } from "./linter.adapter.js";
...
{
	constructor(
		@inject(MeetupIssueService)
		protected readonly meetupIssueService: MeetupIssueService,
	) {}
	...
	protected updateMeetupIssueIfNeeded(
		...
		if (meetupIssue.parsedBody[fieldName] !== data) {
			...
			this.meetupIssueService.updateMeetupIssueBodyField(
				meetupIssue,
				fieldName,
			);
		}
	...
	protected abstract getValidator(): ZodType<
		MeetupIssueBody[MeetupIssueBodyField]
	>;
